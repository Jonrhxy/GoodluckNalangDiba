...
public class PreAsses23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_asses23);

        // Retrieve score from previous activity if available
        score = getIntent().getIntExtra("score", 0);

        // Initialize views
        radioGroup = findViewById(R.id.radiopreQ23);
        submitButton = findViewById(R.id.preq23);
        next11Button = findViewById(R.id.next23);
        timerTextView = findViewById(R.id.timer23); // Ensure you add this TextView in your XML layout
        ...
        submitButton.setOnClickListener(v -> {
            if (!answered) {
                ...
                if (selectedId == -1) {
                    // No answer selected
                    Toast.makeText(PreAsses23.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (selectedId == correctAnswerId) {
                    ...
                    Toast.makeText(PreAsses23.this, "Correct!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(PreAsses23.this, "Incorrect!", Toast.LENGTH_SHORT).show();
                }
        ...
        next11Button.setOnClickListener(v -> {
            ...
            if (answered) {
                Intent intent = new Intent(PreAsses23.this, PreAsses24.class);
                intent.putExtra("score", score);  // Passing the cumulative score to the next activity
                startActivity(intent);
            } else {
                Toast.makeText(PreAsses23.this, "Please submit your answer first", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(TOTAL_TIME, 1000) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(PreAsses23.this, "Time is up! Correct answer is shown.", Toast.LENGTH_SHORT).show();
