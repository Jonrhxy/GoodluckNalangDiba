...
public class BattleEcoStart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(BattleEcoStart.this, "Screen tapped!", Toast.LENGTH_SHORT).show();

                // Navigate to NextActivity when the screen is tapped
                Intent intent = new Intent(BattleEcoStart.this, BattleEcoActivity.class);
