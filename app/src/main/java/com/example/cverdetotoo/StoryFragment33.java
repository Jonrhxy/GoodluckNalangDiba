...
public class StoryFragment33 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_story_fragment33, container, false);
        ImageView imageView = view.findViewById(R.id.storyImage33);
