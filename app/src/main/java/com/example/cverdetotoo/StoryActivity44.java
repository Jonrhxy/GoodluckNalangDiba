...
public class StoryActivity44 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_story44);

        viewPager2 = findViewById(R.id.viewPagerStories44);
        ...
        storyImages.add(R.drawable.trivia41);
        storyImages.add(R.drawable.trivia42);
        storyImages.add(R.drawable.trivia43);
        storyImages.add(R.drawable.trivia44);
        storyImages.add(R.drawable.trivia45);
