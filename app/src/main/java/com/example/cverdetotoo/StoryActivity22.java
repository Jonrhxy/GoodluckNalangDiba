...
public class StoryActivity22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storyImages.add(R.drawable.trivia21);
        storyImages.add(R.drawable.trivia22);
        storyImages.add(R.drawable.trivia23);
        storyImages.add(R.drawable.trivia24);
