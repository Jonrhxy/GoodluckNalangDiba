...
public class Register extends AppCompatActivity {
    ...
    // Updated helper method to validate student ID (exactly two digits, a hyphen, and four digits)
    private boolean isValidStudentId(String id) {
        return id.matches("^[0-9]{2}-[0-9]{4}$"); // Ensures proper format like "21-1977"
    }
    ...
    private void signUpUser() {
        ...
        List<String> allowedIDs = Arrays.asList(
                ...
                "21-1608", "21-2007", "21-1939", "21-1999"
        );
