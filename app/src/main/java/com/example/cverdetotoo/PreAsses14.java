...
public class PreAsses14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pre_asses14);

        // Retrieve score from previous activity if available
        score = getIntent().getIntExtra("score", 0);

        // Initialize views
        radioGroup = findViewById(R.id.radiopreQ14);
        submitButton = findViewById(R.id.preq14);
        next11Button = findViewById(R.id.next14);
        timerTextView = findViewById(R.id.timer14); // Ensure you add this TextView in your XML layout
        ...
        submitButton.setOnClickListener(v -> {
            if (!answered) {
                ...
                if (selectedId == -1) {
                    // No answer selected
                    Toast.makeText(PreAsses14.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        // Set listener for the Next button click to redirect to PreAsses15.class
        next11Button.setOnClickListener(v -> {
            if (answered) {
                Intent intent = new Intent(PreAsses14.this, PreAsses15.class);
                ...
                Toast.makeText(PreAsses14.this, "Please submit your answer first", Toast.LENGTH_SHORT).show();
            }
        });
    }
