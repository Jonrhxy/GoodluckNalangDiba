...
public class videoQCU extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_qcu);

        // Initialize the VideoView, close button, and progress bar
        storyVideo = findViewById(R.id.story_video4);
        closeButton = findViewById(R.id.close_button4);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.qcu);
        ...
        storyVideo.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                Intent intent = new Intent(videoQCU.this, navbar.class);
